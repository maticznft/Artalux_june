...
router.route('/getsettdata').get( adminCtrl.getsettdata);
...
router.route('/AddNFTlist').post( adminCtrl.AddNFTlist); 
...
router.route('/deletecategorys/:id').post(adminCtrl.deletecategorys);


router.route('/setActivateUser').post(adminCtrl.setActivateUser);

//token address fetch
router.route('/tokenaddressAdd').post(adminCtrl.tokenaddressAdd);
router.route('/category/hideshow').get(adminCtrl.hideshows);

router.route('/bpxtoken/add').post(adminCtrl.bpxtokenadd);
//router.route('/gettokenLists').get(adminCtrl.gettokenLists);
router.route('/deletToken/:id').get(adminCtrl.deletToken);
router.route('/gettokensdatalast').get(adminCtrl.gettokensdatalast);
router.route('/edittokensdatalast/:id').get(adminCtrl.edittokensdatalast);


///news letter 
router.route('/getSubscriberList').get(adminCtrl.getSubscriberList);
router.route('/subscriberStatus').post(adminCtrl.subscriberStatus);
router.route('/sendSubscribeMail').post(adminCtrl.newsLetternew);
