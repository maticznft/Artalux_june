...
import { getfaqlist,deletfaq,gettokenList,deletToken } from '../../actions/users';
...
const history = useHistory();
  ...
  function deleteR (id) {
      if(id!='') {
        deletToken(id);
           toast.success('data deleted successfully', toasterOption);
         setTimeout(() => {
  ...
  const add =async () => {
      window.location="/xulatra/tokenpage";
  }
...
const getAll = async (search = {}) => {
...

  {
    ...
    sortable: false,
    cell: (record) =>
   record.ex_img!=''&& <img src={config.Back_Url + '/admin/bpxtoken/exchange/' + record.ex_img} alt="coinimg" height={20} width={20}/>
  },
  {
  ...
  },
  {
    ...
    sortable: false,
    cell: (record) =>
    record.wl_img!=''&& <img src={config.Back_Url + '/admin/bpxtoken/wallet/' + record.wl_img} alt="coinimg" height={20} width={20}/>
  },
  {
    ...
    sortable: false,
    cell: (record) =>
    // <img src={config.Back_Url + '/admin/bpxtoken/wallet/' + record.wl_img} alt="coinimg" height={100} width={100}/>
    <>{record.wl_name}</>
  },
  {
    key: "createdAt",
