...
if(window.ethereum){
  ...
  if(web3&&web3.eth){
	...
	console.log("curr addr lowercase ",currAddr)
	...
	console.log("admin address from contract  2",adminAddress);

	console.log('handleForm>>>>',currAddr, adminAddress);
	if ( adminAddress !== currAddr) {
		console.log("not connected to admin address ");
		toast.warning(' Only Admin can edit',toasterOption)
		return false;
	}
	...
	console.log("req data to update admin profile ",reqData);
