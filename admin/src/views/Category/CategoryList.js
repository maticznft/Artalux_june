...
let toasterOption = {
  ...
  const configdata = {
        ...
        const hideshow=async(senddata)=>{    
               
            axios({
              method:'get',
              url:config.API+'/admin/panel/category/hideshow',
              params:senddata
            })
            .then((data)=>{
              toast.success("Now can show in home page")
   ...
   function pageChange(pageData) {
     ...
     function editR(id) 
    {
        ...
        if(id!='') {
            window.location.href="/xulatra/EditCategory/"+id;
        }
