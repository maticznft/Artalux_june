...
console.log("req data to gettokendata in viewtoken ",reqdata);
    ...
    const Burntoken=async(data)=>{
       ...
       var type=data.type;
        ...
        var CoursetroContract = new web31.eth.Contract(EXCHANGE, config.exchangeAddress);
 ...
 const back = async () => {
     window.location.href='/xulatra/SupportTicket';
    }
    const onChange = (e) => {
        e.preventDefault();
