...
export const addcategory = async (data) => {
    try {
        let bodydatafor = new FormData();
        bodydatafor.append('name',data.name)
        bodydatafor.append('image',data.image)
        ...
        console.log("formdata",bodydatafor,data)
        return {
            loading: false,
        }
...
export const deletecategory = async (id, dispatch) => {
    ...
    try {
        let respData = await axios({
            'method': 'post',
            'url': `${config.API}/admin/panel/deletecategorys/` + id,
            'headers': {
                'Authorization': localStorage.admin_token
            },
        });
...
export const deletToken = async (id, dispatch) => {
    ////console.lo('yes');
    try {
        let respData = await axios({
            'method': 'get',
            'url': `${config.API}/admin/panel/deletToken/` + id,
            'headers': {
                'Authorization': localStorage.admin_token
            },
        });
...
export const getsettdata = async (token, dispatch) => {
    ...
    try {
        ...
        console.log("err in getting social links ",err);
        return {
            loading: false,
            error: err.response.data.errors
        }
...
export const gettokenList = async (data, dispatch) => {
    //console.lo('yes')
    try {
        let respData = await axios({
            'method': 'get',
            'url': `${config.API}/admin/panel/gettokenLists`,
...
export const setactivateUserAction = async (data) => {
    try {
        let respData = await axios({
            'method': 'post',
            'url': `${config.API}/admin/panel/setActivateUser`,
            data
        });
        return {
            loading : false,
...
export const getSubscriberList = async () => {
    ...
    try {
        let respData = await axios({
            'method': 'get',
            'url': `${config.API}/admin/panel/getSubscriberList`,
        });
  ...
  export const sendSubscriberMail = async (data) => {
    ...
    try { 
        let respData = await axios({
            'method': 'post',
            'url': `${config.API}/admin/panel/sendSubscribeMail`,
            data
        });
  ...
  export const updateSubscriberStatus = async (data) => {
    try {
        let respData = await axios({
            'method': 'post',
            'url': `${config.API}/admin/panel/subscriberStatus`,
            data: data
        });
        return respData.data
    }
